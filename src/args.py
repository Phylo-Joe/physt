...
class Args:
    ...
    def GetArgs(self) -> None:
        ...
        PARSER.add_argument(
            "--msa",
            type=str,
            help="input MSA in Phylp/Fasta/Nexus/Clustal format",
            required=True,
        )
        PARSER.add_argument(
            "--init-trees",
            type=int,
            help="the number of initial trees generated",
            default=100,
            required=False,
        )
        PARSER.add_argument(
            "--mp-trees",
            type=int,
            help="number of MP trees passed to ML software",
            default=5,
            required=False,
        )
        PARSER.add_argument(
            "--init-software",
            type=str,
            help="software used to generate initial trees",
            default="mpboot",
            required=False,
        )
        PARSER.add_argument(
            "--ml-software",
            type=str,
            help="software used to generate ML trees",
            default="iqtree",
            required=False,
        )
        PARSER.add_argument(
        ...
        PARSER.add_argument(
            "--max-parallel",
            type=bool,
            help="run PHYST using maximum resources",
        ...
        PARSER.add_argument(
            "--iqtree-options",
            type=str,
            help="give iq-tree any user specified options",
            default="",
            required=False,
        )
        PARSER.add_argument(
            "--verbose",
            type=bool,
            help="turn on verbose mode (debug logs)",
            default=False,
            action=argparse.BooleanOptionalAction,
            required=False,
        )
        PARSER.add_argument(
            "--config",
            type=str,
            help="path to config file from root directory",
